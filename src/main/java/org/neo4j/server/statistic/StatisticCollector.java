...
public class StatisticCollector extends TimerTask {
    ...
    private int purgeTime = 60 * 60 * 24;

    /**
     * @param purgeTime in seconds
     */
     ...
     */
    public synchronized void writeJson(final PrintWriter writer) throws IOException {
        new ObjectMapper().writer().writeValue(writer, records);
    }
}
